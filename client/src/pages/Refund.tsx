        ...
        <div className="container max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8 text-sm leading-relaxed text-muted-foreground">
            <div className="p-6 rounded-2xl bg-green-50 border border-green-100">
              ...
              <p className="text-green-800">Play By Stats is a 100% free platform. Since we do not charge any fees, accept any deposits, or process any payments, there are no refunds applicable. This policy exists for transparency and compliance purposes.</p>
            </div>

            <div>
              <h2 className="text-xl font-bold text-foreground mb-3" style={{ fontFamily: "var(--font-heading)" }}>1. No Monetary Transactions</h2>
              <p>Play By Stats does not involve any monetary transactions. We do not:</p>
            ...
            <div>
              ...
              <p>Users may request account cancellation at any time by contacting our support team at <strong className="text-foreground">support@playbystats.com</strong>. Upon cancellation:</p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
