        ...
        <div className="container relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-white/70 leading-relaxed max-w-2xl mx-auto">
              StrikePlay is India's free cricket entertainment platform, built with a mission to make cricket fun accessible to every cricket enthusiast — completely free of charge.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <motion.div variants={fadeIn} custom={0}>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  StrikePlay was created by a passionate team of cricket lovers who believe that every fan deserves the opportunity to experience the joy of building their own team and competing with others — without having to worry about money.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Our platform is designed to be educational, entertaining, and community-driven. Whether you're a seasoned cricket analyst or a newcomer to the sport, StrikePlay provides the tools and resources you need to enjoy cricket entertainment.
                </p>
